...
# ---------------------------------------------------------------------------
# Cross-run dedup — persist seen tweet IDs between runs
# ---------------------------------------------------------------------------
...
def load_seen_posts() -> dict[str, str]:
    """Load {tweet_id: iso_timestamp} from disk. Returns empty dict on error."""
        ...
        for acct in accounts:
            ...
            for raw in raw_tweets:
                ...
                if tweet.id in seen_ids:
                    if tweet.id in previously_seen and tweet.id not in new_ids:
